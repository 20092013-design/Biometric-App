...
{
  public partial class VerificationImage : Form {
        ...
        public VerificationImage(AppData data)
    {
        ...
        private void GetPhoto()
        {
            ...
            getFingerPrintModel.FingerNo = int.Parse(string.IsNullOrEmpty(AppData.EnrolledFingers) ? "6" : AppData.EnrolledFingers);
            ...
            FingerNo = BiometricResponse.FingerNo.ToString();
                            ...
                            fpImage.SizeMode = PictureBoxSizeMode.StretchImage;                            
                            fpImage.Image = ByteToImage(AppData.imagedata);
      ...
      Service service = new Service();
        ...
        private void zkFprint_OnCapture(object sender, IZKFPEngXEvents_OnCaptureEvent e)
        {
            ...
            SqlDataReader read = (null);
                ...
                //string result = System.Text.Encoding.UTF8.GetString(AppData.imagedata);
                            ...
                            fpImage.Visible = true;
                            fpImage.Image = ByteToImage(ImageToByte(fpicture.Image));
        ...
        private void CloseButton_Click(object sender, EventArgs e)
        {
            //try
            //{
            //    if (GetOperatorID.Level == "PS" || GetOperatorID.Level == "PG")
            //        this.Close();
            //    else
